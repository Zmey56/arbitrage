...
func getResultP2P2stepsOKXBinanceTT(a, fiat string, paramUser getinfookx.ParametersOKX) {
	...
	//log.Println("PARAM USER", paramUser, len(order_buy.Data.Sell), "asset", a)
...
func printResultP2P2stepsOKXBinanceTT(a, fiat string, transAmountFirst, price_b float64,
	...
	if len(order_sell.Data) < 2 {
		...
		profitResult := deltaBuySellOBTT(order_buy, order_sell, a, fiat, paramUser)
		log.Println("profitResult", profitResult)
